...
- Add `read_json_body_after_http_success_limited(...)` so callers can keep success-path JSON body limits explicit instead of inheriting the generic 16 KiB default.
