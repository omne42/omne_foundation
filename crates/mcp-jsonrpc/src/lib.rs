    ...
    impl Error {
        ...
        pub fn into_error_record(self) -> ErrorRecord {
            match self {
                ...
                Self::Json(source) => {
                    build_json_error_record(source.to_string()).with_source(source)
                }
                Self::Rpc {
                    code,
                    message,
